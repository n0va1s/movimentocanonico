        ...
        <div class="mb-6 space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3" role="list" aria-label="Informações do evento">
                <div role="listitem"
                    ...
                    <flux:icon.users class="w-5 h-5 text-blue-500 shrink-0" aria-hidden="true" />
                    <div>
                ...
                <div role="listitem"
                    class="flex items-center gap-2 sm:gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-2 sm:p-3">
                    <flux:icon.calendar class="w-5 h-5 text-red-500 shrink-0" aria-hidden="true" />
                    <div>
                ...
                <div role="listitem"
                    class="flex items-center gap-2 sm:gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-2 sm:p-3">
                    <flux:icon.ticket class="w-5 h-5 text-green-500 shrink-0" aria-hidden="true" />
                    <div>
                ...
                <div role="listitem"
                    class="flex items-center gap-2 sm:gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-2 sm:p-3">
                    <flux:icon.currency-dollar class="w-5 h-5 text-yellow-500 shrink-0" aria-hidden="true" />
                    <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                ...
                <div
                    class="flex items-start gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-3">
                    <flux:icon.device-phone-mobile class="w-5 h-5 text-cyan-500 shrink-0 mt-0.5"
                        aria-hidden="true" />
                    <div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <select name="idt_falar_com" id="idt_falar_com" required x-bind:disabled="bloqueado"
                                    ...
                                    <option class="dark:bg-zinc-700" value="" disabled
