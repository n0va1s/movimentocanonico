...
<body
    ...
    <div
        ...
        <div style="text-align: center; padding-bottom: 20px;">
            <h1 style="color: #004d40; margin: 0;">[NOME DO MOVIMENTO]</h1>
            <p style="color: #00796b;">Paróquia Nossa Senhora do Lago</p>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0; border: 1px solid #e0e0e0;">
            <tr>
                <td style="padding: 12px; background-color: #f9f9f9; width: 30%; font-weight: bold; border: 1px solid #e0e0e0;">E-mail:</td>
                <td style="padding: 12px; background-color: #ffffff; width: 70%; border: 1px solid #e0e0e0;">{{ $email }}</td>
            </tr>
            @if(!empty($senha))
            <tr>
                <td style="padding: 12px; background-color: #f9f9f9; font-weight: bold; border: 1px solid #e0e0e0;">Senha Temporária:</td>
        ...
        @if(!empty($senha))
        <p style="font-size: 0.9em; color: #e67e22; padding: 10px; background-color: #fffbe6; border-left: 3px solid #e67e22;">
            <strong>Lembrete Importante:</strong> Sua senha inicial é a sua <strong>data de nascimento</strong> no formato
            <strong>AAAAMMDD</strong> (por exemplo, 19850520). Por favor, altere esta senha após seu primeiro acesso para garantir
            sua segurança.
        </p>
        @endif

        <p style="font-size: 1.05em; color: #444;">
            Participe do <strong>Aura</strong>! Você ganhará pontos em cada evento que participar, crescendo junto com nossa comunidade.
        </p>
        ...
        <p style="margin-top: 30px;">
            A Paz de Cristo,<br>
            A Equipe do Movimento Canônico<br>
            <a href="https://movimento.canonico.com.br">https://movimento.canonico.com.br</a>
        </p>
    </div>
